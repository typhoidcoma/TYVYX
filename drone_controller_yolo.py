    ...
    try:
        while True:
            ...
            if ret and frame is not None:
                ...
                # Add overlay info
                y_offset = 30
                cv2.putText(processed_frame, "TEKY Drone - YOLO11 Ready (Press Q to quit)", 
                           (10, y_offset), cv2.FONT_HERSHEY_SIMPLEX, 
                           0.6, (0, 255, 0), 2)
                
                y_offset += 25
                cv2.putText(processed_frame, f"Device: {drone.device_type} | Connected: {drone.is_connected}", 
                           (10, y_offset), cv2.FONT_HERSHEY_SIMPLEX, 
                           0.5, (0, 255, 0), 1)
            ...
            # YOLO controls
                ...
                print(f"FPS display: {'ON' if drone.video_processor.show_fps else 'OFF'}")
